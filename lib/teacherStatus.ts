 ...
 *
 * Regra:
 * - Se facilitador tem pelo menos 1 grupo ativo (eh_ativo = true, arquivada = false) => teacher.eh_ativo = true
 * - Se facilitador não tem grupos ativas => teacher.eh_ativo = false
 */
